    ...
    <>
      {isRecording ? (
        ...
        <button
          ...
          disabled={isLoading}
          className="flex max-h-14 items-center border border-secondary border-opacity-30 bg-seagreen rounded-xl px-4 py-3 ml-3 mr-3 font-semibold hover:bg-btnHoverBlue"
        >
